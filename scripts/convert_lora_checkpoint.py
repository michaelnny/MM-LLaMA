...
if __name__ == '__main__':
    ...
    merge_lora_checkpoint(
        base_ckpt_path='/home/michael/models/meta_llama2/llama-2-7b-chat/consolidated.pth',
        lora_ckpt_path='./checkpoints/pretrain/lora_7B-steps-4400.pth',
        save_path='./checkpoints/7b-pretrain/7B-steps-4400-consolidated.pth',
    )

    # fine-tuned model
    merge_lora_checkpoint(
        base_ckpt_path='./checkpoints/7b-pretrain/7B-steps-4400-consolidated.pth',
        lora_ckpt_path='./checkpoints/finetune_lora/lora_7B-steps-6600.pth',
        save_path='./checkpoints/7b-finetune/7B-steps-6600-consolidated.pth',
    )
