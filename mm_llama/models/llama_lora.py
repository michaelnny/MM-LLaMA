...
import mm_llama.models.llama as llama
from mm_llama.models.lora import LoRALinear, LoRALinear4bit, Linear4bit
...
class LoraModelArgs(llama.ModelArgs):
    ...
    lora_lm_head: bool = False  # train model output layer
...
def _get_lora_linear_layer(args: LoraModelArgs) -> Union[LoRALinear, LoRALinear4bit]:
    ...
    if args.quant_lora_4bit:  # quantize LoRALinear layer
...
def _get_linear_layer(args: LoraModelArgs) -> Union[nn.Linear, Linear4bit]:
    layer_cls = None
    kwargs = {}
    if args.quant_4bit:  # quantize frozen linear layer
        kwargs.update(_get_quant_kwargs(args))
